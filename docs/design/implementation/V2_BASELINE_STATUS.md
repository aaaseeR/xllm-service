...
| xLLM Service + xLLM Native | 模板、Provider Contract 与 Service 公共路径 | 当前外层 xLLM `cd91965c` | CPU_VERIFIED | 113/113 tests passed |
...
| DEV-CROSS-REPO | xllm-service 对 xLLM `cd91965c` override 构建与测试 | N/A | N/A | PASS |
