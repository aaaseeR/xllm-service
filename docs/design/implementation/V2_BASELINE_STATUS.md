...
| --- | --- | --- | --- | --- |
| xLLM Native | CPU 公共路径 | 协议、Provider/Event wire、资源状态机、流式语义、JSON 解析 | CPU_VERIFIED | 84/84 tests passed |
...
| DEV-CPU-XLLM | `xllm-dev xllm-test <xllm> native Debug` | 当前目标链接 Torch CPU；新增资源核心不含 tensor 逻辑 | N/A | PASS，84/84 |
