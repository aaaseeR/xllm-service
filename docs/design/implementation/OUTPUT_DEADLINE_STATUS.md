...
| 双仓回归 | xLLM 默认 CPU 六目标 97/97，另有 output queue 14/14、protocol 14/14；Service 293/293；vLLM Agent/sidecar 60/60；Service 三个生产二进制 build/link verify | Torch CPU queue/所有权测试通过 | N/A | PASS |
