...
| 双仓回归 | xLLM 默认 CPU 七目标 100/100，另有 output queue 14/14、protocol 14/14；Service pinned/override 均为 304/304；vLLM Agent/sidecar 60/60；Service 三个生产二进制 build/link verify | Torch CPU queue/所有权测试通过 | N/A | PASS |
