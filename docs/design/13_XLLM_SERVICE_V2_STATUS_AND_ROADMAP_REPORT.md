...
| 交付门禁 | 512/512 Service tests、141/141 xLLM CPU contract、65/65 vLLM sidecar tests；V2/V3 离线多进程 E2E、并发压测与故障矩阵 | [离线集群硬门](./implementation/OFFLINE_E2E_GATE_STATUS.md) |
