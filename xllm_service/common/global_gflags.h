...
DECLARE_uint64(kv_route_max_candidate_plans);
DECLARE_uint64(kv_route_least_load_shortlist);
DECLARE_uint64(kv_route_top_prefix_shortlist);
DECLARE_uint64(kv_route_prefill_queue_cost_us);
DECLARE_uint64(kv_route_decode_request_cost_us);
DECLARE_uint64(kv_route_prefill_token_cost_us);
DECLARE_double(kv_route_transfer_byte_cost_us);
DECLARE_uint64(kv_route_decode_headroom_cost_us);
DECLARE_uint64(kv_route_prefill_reserve_blocks);
DECLARE_uint64(kv_route_margin_us);
DECLARE_uint64(kv_route_near_equal_cost_us);
